...
fixtures = ["Custom Field", "Function", "Industry", "LMS Category", "Faq", "Colab Companies"]
...
website_route_rules = [
	...
	{"from_route": "/course_list", "to_route": "course_list"},
    {"from_route": "/team_trainig_program", "to_route": "team_training"},
    {"from_route": "/courses/<category>", "to_route": "courses"},
    {"from_route": "/course/<course_id>", "to_route": "course_detail"},  
	{"from_route": "/about", "to_route": "about"},  # Add this line
